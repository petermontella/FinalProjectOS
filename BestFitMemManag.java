...
public class BestFitMemManag {
    ...
    public BestFitMemManag(){
        ...
        memSpace.add(new MemObj(900));
        memSpace.add(new MemObj(1200));
        memSpace.add(new MemObj(800));
        memSpace.add(new MemObj(1600));
        memSpace.add(new MemObj(400));
...
Parameters: array list of memory blocks; number of memory blocks;
     ...
     */
    public void bestFit(ArrayList<MemObj> x, int mSp, ArrayList<ProcessClass> y, int pSi) {
